export default class EUFuckingLaw {
  ...
  init (parentSelector) {
    ...
    infoTextElement.innerText = `
      Diese Seite verwendet Cookies. NAch EU-Richtlinien sind wir verpflichtet, Ihnen dies mitzuteilen und Ihnen die Möglichkeit zu gewähren,
